      ...
      <div className="fixed right-4 top-4 z-[90] grid w-[calc(100vw-2rem)] max-w-sm gap-3">
        {toasts.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="flex gap-3 rounded-lg border border-black/10 bg-white p-4 shadow-luxe"
            >
              <Icon
                className={
              ...
              <button
                ...
                className="h-7 w-7 shrink-0 rounded-full border border-black/10 text-black/50"
              >
