  ...
  return (
    <main>
      <section className="bg-black text-white">
        <div className="container-luxe grid min-h-[auto] items-center gap-8 py-12 md:py-16 lg:min-h-[60vh] lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-xl text-white/65">
              Commission a one-off piece designed around your dimensions,
              materials, artwork and story.
            </p>
          </div>
          {/* <img
            src="/images/category-bespoke.jpg"
            alt="Bespoke wooden plaque"
