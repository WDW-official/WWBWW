...
const journal = [
  [
    'Behind the scenes: The laser cutting process',
    'May 14, 2026',
    '/images/mockup/journal-laser.jpg',
  ],
  [
    'Design inspiration: Nature’s geometry',
    'Apr 28, 2026',
    '/images/mockup/journal-tree.jpg',
  ],
  [
    'Interior installations: Adding warmth with wood',
    'Apr 12, 2026',
    '/images/mockup/journal-lamp.jpg',
  ],
  [
    'Custom projects: Bespoke creations',
    'Mar 30, 2026',
    '/images/mockup/journal-mandala.jpg',
  ],
]
    ...
    <main>
        ...
        <div className="grid min-h-[auto] items-stretch lg:min-h-[560px] lg:grid-cols-[0.92fr_1.08fr]">
          <div className="relative z-20 flex items-center px-5 py-12 md:px-8 md:py-16 lg:py-20 lg:pl-[max(2.5rem,calc((100vw-1500px)/2+2.5rem))] lg:pr-10">
            <div className="max-w-xl">
              <h1 className="editorial text-[38px] italic leading-[.9] md:text-[72px] lg:text-[78px]">
                ART.
                <br />
                CUT WITH
                <br />
              ...
              <p className="mt-6 max-w-sm text-base leading-6 text-black/70">
                Contemporary decorative art crafted through the precision of
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <Link
                  href="/custom-work"
                  className="inline-flex items-center rounded-md border border-black/40 px-6 py-3 text-xs font-semibold uppercase tracking-[0.13em]"
                >
          ...
          <div className="relative hidden min-h-[290px] md:min-h-[390px] lg:block lg:min-h-[560px]">
            ...
            <img
              ...
              alt="Intricate layered wooden mandala"
      ...
      <section className="container-luxe py-10">
        <div className="mb-8 flex items-center gap-5">
          <div className="h-px flex-1 bg-[#b9935e]" />
          <h2 className="editorial text-center text-2xl tracking-wide md:text-3xl">
            FEATURED PRODUCTS
          </h2>
          <div className="h-px flex-1 bg-[#b9935e]" />
        </div>
        ...
        <div className="mt-7 text-center">
          <Link
            href="/shop"
            className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[.14em]"
          >
      ...
      <section className="container-luxe py-5">
        <div className="grid overflow-hidden rounded-xl bg-[#171717] text-white lg:grid-cols-[.55fr_1.45fr]">
          <img
            src="/images/mockup/custom-plaque.jpg"
            alt="Bespoke Williams wooden plaque"
            className="h-full min-h-[310px] w-full object-cover"
          />
          <div className="grid gap-8 p-8 md:p-12 lg:grid-cols-[.9fr_1.1fr]">
            <div>
              <h2 className="editorial text-5xl italic leading-[.9]">
                YOUR IDEA.
                <br />
                OUR CRAFT.
              </h2>
              <p className="mt-5 text-sm leading-6 text-white/65">
                Create something that exists nowhere else. From names and dates
                to intricate artwork and completely original designs, we turn
                your ideas into precision-cut wooden pieces.
              </p>
            ...
            <div className="grid gap-3 text-xs sm:grid-cols-2">
              <div className="flex gap-3">
                <Check className="text-[#c89a59]" size={17} />
                <span>Tell us what you want</span>
              </div>
              <div className="flex gap-3">
                <ImagePlus className="text-[#c89a59]" size={17} />
                <span>Upload artwork or inspiration</span>
              </div>
              <div className="flex gap-3">
                <Palette className="text-[#c89a59]" size={17} />
                <span>Choose your material</span>
              </div>
              <div className="flex gap-3">
                <Ruler className="text-[#c89a59]" size={17} />
                <span>Choose your size</span>
              </div>
              <div className="flex gap-3">
                <FileCheck className="text-[#c89a59]" size={17} />
                <span>Receive a design proof</span>
              </div>
              <div className="flex gap-3">
                <Sparkles className="text-[#c89a59]" size={17} />
                <span>We cut, engrave & create</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container-luxe py-10">
        <div className="grid overflow-hidden rounded-xl border border-black/10 bg-white lg:grid-cols-[.55fr_1.45fr]">
          <div className="p-8 md:p-10">
            <h2 className="editorial text-4xl leading-[.95]">
              WHERE CRAFT
              <br />
              MEETS TECHNOLOGY.
            </h2>
            <p className="mt-5 text-sm leading-6 text-black/60">
              Woodworks by Walé Williams combines an appreciation for
              traditional craftsmanship with modern digital design and precision
              laser technology.
            </p>
            <p className="mt-4 text-sm leading-6 text-black/60">
              The machine provides precision. The design provides imagination.
              The craftsmanship brings it to life.
            </p>
          </div>
      ...
      {/* <section className="container-luxe py-4">
        <div className="flex items-end justify-between">
          <div>
            <div className="text-xs uppercase tracking-[.14em]">From sheet</div>
            <h2 className="editorial mt-1 text-4xl">TO STATEMENT PIECE.</h2>
          </div>
          <Link href="/journal" className="text-xs uppercase tracking-[.12em]">
            View all
          </Link>
        </div>
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {journal.map(([t, d, i]) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h3 className="text-sm font-medium leading-5">{t}</h3>
                <p className="mt-2 text-[10px] uppercase tracking-wider text-black/45">
                  {d}
                </p>
              </div>
            </article>
      ...
      <section className="container-luxe pb-10">
        <div className="rounded-xl border border-black/10 bg-[#f1ede6] p-7 md:flex md:items-center md:justify-between">
          <div>
            <h3 className="editorial text-3xl">JOIN THE WORKSHOP.</h3>
            <p className="mt-2 text-sm text-black/55">
              Be the first to discover new designs, limited collections, bespoke
              projects and behind-the-scenes stories.
            </p>
          </div>
          <div className="mt-5 flex w-full max-w-lg md:mt-0">
            <input
              className="min-w-0 flex-1 rounded-l-md border border-black/15 bg-white px-4 py-3 text-sm outline-none"
              placeholder="ENTER YOUR EMAIL"
            />
            <button className="rounded-r-md bg-champagne px-6 text-xs uppercase tracking-wider text-white">
              Subscribe
            </button>
          </div>
        </div>
